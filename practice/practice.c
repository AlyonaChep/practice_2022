...
int convert(x)
{
    ...
    switch (units)
    {
        case 1: printf("%s ", units_arr[0]); ending = 1; break; // 1
        case 2: printf("%s ", units_arr[1]); ending = 2; break; // 2
        case 3: printf("%s ", units_arr[2]); ending = 2; break; // 3
        case 4: printf("%s ", units_arr[3]); ending = 2; break; // 4
